...
- QR `QR_Mentimeter_Join.png`
- Projector/จอสำหรับแสดงผล Mentimeter
- Teacher Dashboard
- แผนสำรอง Mouse/Touch และแผนสำรองกรณีอินเทอร์เน็ตมีปัญหา

> ก่อนสอนให้ทดสอบลิงก์ตรงและ QR แล้วตรวจว่ารหัส **7812 2870** ยังเป็นรหัสปัจจุบัน หากรหัสเปลี่ยนให้ใช้ลิงก์ตรง/QR เป็นหลักและแก้รหัสบนจอ
...
- QR บนสไลด์
- หรือเข้า `menti.com` แล้วกรอกรหัส **7812 2870**
...
- [ ] QR `QR_Mentimeter_Join.png` เปิด presentation ได้
- [ ] ตรวจรหัส Menti ปัจจุบัน (ล่าสุด **7812 2870**)
